...
public class CharactersList extends ArrayList<Character> {
    ...
    /**
     * Remove face up a certain amount of character cards from the character cards deck according to the number
    ...
    /**
     * Remove face down a certain amount of character cards from the character cards deck according to the number of
     * players in the game.
     *
